...
const DOOR_OPEN_SOUND = preload("res://shooter/assets_sht/sounds/misc/sci-fi-door.wav")
const POWER_UP_DEPLOY = preload("res://shooter/assets_sht/sounds/powerup/power_up_deploy.wav")


const POWER_UP_SOUNDS = {
	GameData.POWERUP_TYPE.HEALTH: preload("res://shooter/assets_sht/sounds/powerup/health_16.wav"),
	GameData.POWERUP_TYPE.SHIELD: preload("res://shooter/assets_sht/sounds/powerup/shield_18.wav")
}
...
func make_explosion_sound(file_num: int) -> String:
	return "res://shooter/assets_sht/sounds/explosions/sfx_exp_medium%s.wav" % file_num


func make_laser_sound(file_num: int) -> String:
	return "res://shooter/assets_sht/sounds/lasers/sfx_wpn_laser%s.wav" % file_num
